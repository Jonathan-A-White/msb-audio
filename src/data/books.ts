...
const booksRaw: Book[] = [
  ...
  { number: 22, abbr: 'Sol', name: 'Song of Solomon', testament: 'OT' },
  ...
  { number: 26, abbr: 'Eze', name: 'Ezekiel', testament: 'OT' },
  { number: 27, abbr: 'Dan', name: 'Daniel', testament: 'OT' },
  { number: 28, abbr: 'Hos', name: 'Hosea', testament: 'OT' },
  { number: 29, abbr: 'Joe', name: 'Joel', testament: 'OT' },
  ...
  { number: 34, abbr: 'Nah', name: 'Nahum', testament: 'OT' },
  ...
  { number: 41, abbr: 'Mar', name: 'Mark', testament: 'NT' },
  { number: 42, abbr: 'Luk', name: 'Luke', testament: 'NT' },
  { number: 43, abbr: 'Joh', name: 'John', testament: 'NT' },
  ...
  { number: 50, abbr: 'Phi', name: 'Philippians', testament: 'NT' },
  ...
  { number: 56, abbr: 'Tit', name: 'Titus', testament: 'NT' },
  { number: 57, abbr: 'Phm', name: 'Philemon', testament: 'NT' },
  { number: 58, abbr: 'Heb', name: 'Hebrews', testament: 'NT' },
  { number: 59, abbr: 'Jam', name: 'James', testament: 'NT' },
  { number: 60, abbr: '1Pe', name: '1 Peter', testament: 'NT' },
  { number: 61, abbr: '2Pe', name: '2 Peter', testament: 'NT' },
  { number: 62, abbr: '1Jo', name: '1 John', testament: 'NT' },
  { number: 63, abbr: '2Jo', name: '2 John', testament: 'NT' },
  { number: 64, abbr: '3Jo', name: '3 John', testament: 'NT' },
